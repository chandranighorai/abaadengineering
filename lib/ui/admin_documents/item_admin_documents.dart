...
class ItemAdminDocuments extends StatefulWidget {
  final AdminDocumentsList adminDocumentsList;

  const ItemAdminDocuments({Key key, this.adminDocumentsList})
      : super(key: key);
  @override
  _ItemAdminDocumentsState createState() => _ItemAdminDocumentsState();
}

class _ItemAdminDocumentsState extends State<ItemAdminDocuments> {
  ...
  Widget build(BuildContext context) {
    AdminDocumentsList adminDocument = widget.adminDocumentsList;
    var mExt = adminDocument.adocumentsImage
        .split(".")[adminDocument.adocumentsImage.split(".").length - 1];
    return InkWell(
      onTap: () {
        showAlertWithOkCancel(
          ...
          () {
            ...
            downloadFile(context, adminDocument.adocumentsImage);
          },
          () {
            Navigator.pop(context);
          },
