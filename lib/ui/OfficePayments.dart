...
class OfficePayments extends StatefulWidget {
  @override
  _OfficePaymentsState createState() => _OfficePaymentsState();
}

class _OfficePaymentsState extends State<OfficePayments> {
  @override
