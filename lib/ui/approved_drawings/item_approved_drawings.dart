...
class ItemApproveDrawings extends StatefulWidget {
  final ApprovedDrawingsList approvedDrawingsList;

  const ItemApproveDrawings({Key key, this.approvedDrawingsList})
      : super(key: key);
  @override
  _ItemApproveDrawingsState createState() => _ItemApproveDrawingsState();
}

class _ItemApproveDrawingsState extends State<ItemApproveDrawings> {
  ...
  Widget build(BuildContext context) {
    ApprovedDrawingsList appRovedDesign = widget.approvedDrawingsList;
    var mExt = appRovedDesign.drawingsImage
        .split(".")[appRovedDesign.drawingsImage.split(".").length - 1];
    return InkWell(
      onTap: () {
        showAlertWithOkCancel(
          ...
          () {
            ...
            downloadFile(context, appRovedDesign.drawingsImage);
          },
          () {
            Navigator.pop(context);
          },
                    ...
                    ? Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image:
                                NetworkImage("${appRovedDesign.drawingsImage}"),
                            fit: BoxFit.cover,
                          ),
                        ),
                      )
